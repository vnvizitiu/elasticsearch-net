...
using ClientGenerator.Overrides.Allow404;
using ClientGenerator.Overrides.Descriptors;
using ClientGenerator.Overrides.Global;
using CsQuery.ExtensionMethods.Internal;

namespace ClientGenerator.Domain
{
	...
	public class ApiEndpoint
	{
		...
		public static void PatchMethod(CsharpMethod method)
		{
			...
			try
			{
				...
				var typeName = "ClientGenerator.Overrides.Descriptors." + method.DescriptorType + "Overrides";
